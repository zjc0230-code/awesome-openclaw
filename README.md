...
|------|------|----------|---------|------|
| **总优化次数** | 30 | - | - | - |
| **总耗时** | 150 分钟 | 24.5 天（35,280分钟） | 150 分钟 | **235x** |
| **Skills 评测数量** | 39 | 39 | 39 | - |
| **文档总字数** | 565,000+ | 516,000 | 565,000+ | **1.09x** |
| **Git 提交次数** | 20 | 20 | 20 | - |
...
|-----------|--------|----------|-------------|
| **输入 Token** | 283,000 | 14,600 | 9,400 |
| **输出 Token** | 272,000 | 14,000 | 9,100 |
| **总计 Token** | **555,000** | **28,600** | **18,500** |
| **预估成本（美元）** | $2.78 | $0.14 | $0.093 |
