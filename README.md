...
|------|------|----------|---------|------|
| **总优化次数** | 29 | - | - | - |
| **总耗时** | 145 分钟 | 24.0 天（34,560分钟） | 145 分钟 | **238x** |
| **Skills 评测数量** | 38 | 38 | 38 | - |
| **文档总字数** | 516,000+ | 488,000 | 516,000+ | **1.06x** |
| **Git 提交次数** | 20 | 20 | 20 | - |
...
|-----------|--------|----------|-------------|
| **输入 Token** | 258,000 | 14,300 | 8,900 |
| **输出 Token** | 247,000 | 13,700 | 8,500 |
| **总计 Token** | **505,000** | **28,000** | **17,400** |
| **预估成本（美元）** | $2.53 | $0.14 | $0.087 |
