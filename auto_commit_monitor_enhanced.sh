...
# 路径: /data/workspace/awesome-openclaw/auto_commit_monitor_enhanced.sh

PROJECT_DIR="/data/workspace/awesome-openclaw"
CHECK_SCRIPT="$PROJECT_DIR/run_check_with_notify.sh"
PID_FILE="$PROJECT_DIR/.auto_commit_monitor_enhanced.pid"
LOG_FILE="$PROJECT_DIR/auto_commit_monitor_enhanced.log"

echo "======================================" >> "$LOG_FILE"
echo "[$(date '+%Y-%m-%d %H:%M:%S')] 启动增强版自动提交监控" >> "$LOG_FILE"
